...
# Make sure that 'spike-tag' is compiled with no optional features
run-test "spike" "half-tag"

# Make sure that 'spike-tag' is configured and compiled with --enable-tag-mem-loose
# run-test "spike-loose" "half-tag"

# Make sure that 'spike-tag' is configured and compiled with --enable-tag-mem-strict
# run-test "spike-strict" "half-tag"
